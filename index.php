                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>We are committed to helping you unlock your real estate potential andcontinually evolve with your changing needs......</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Where it is commercial or residential property, our experience in real estate can get you the best value for your budget......</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>We will sort properties as per your requirements,where it is commercial or residential property........</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>We offer real estate consultation,soluution and documentation solution for hassle-free experience at one place.....</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Comprising our 14+ years experience in the real estate market,our agency provides a complete package of services covering the sale,leasing,rental and management of residential as well as comertial property.....</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>We are able to provide expert advice in the areas of property consultancy.We provide best services in real estate market......</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Comprising our 14+ years experience in the real estate market,We have best peoples to guide you while buying or renting any property.....</p>
									</div>
                                </li>
                            </ul>
                        </div>
					...
					<div class="col-lg-12">
						<div class="content-sidebar p-4">
							<div class="mb-3 col-lg-12">
								<h4 class="double-down-line-left text-secondary position-relative pb-4 mb-4">Feedbacks</h4>

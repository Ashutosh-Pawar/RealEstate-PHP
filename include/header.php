                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <ul class="top-contact list-text-white  d-table">
                                <li><a href="#"><i class="fas fa-phone-alt text-success mr-1"></i>+91 702 8100 208</a></li>
                                <li><a href="#"><i class="fas fa-envelope text-success mr-1"></i>omkar.realestatepune</a></li>
                            </ul>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <nav class="navbar navbar-expand-lg navbar-light p-0"> <a class="navbar-brand position-relative" href="index.php">
                                <img class="nav-logo" src="images\logo\black_logo.png" alt="" style="height:65px;"></a>
